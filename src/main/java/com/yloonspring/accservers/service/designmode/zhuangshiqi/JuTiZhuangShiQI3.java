 ...
 * @版本: 1.0
 */
public class JuTiZhuangShiQI3 extends ShapeZhuangShiQI {

	/* 每一个装饰器都要实现的构造方法，用来增加上一个装饰器的功能 ，迭代装饰器用 */
	public JuTiZhuangShiQI3(Shape shape) {
	...
	public void draw() {
		...
		System.out.println("装饰器3drawstart");
		super.draw(); // 使用被装饰类的原生方法
		System.out.println("装饰器3drawend");
		setRedBorder(shape); // 增加装饰器装饰

	}

	private void setRedBorder(Shape shape) {
		System.out.println("内部涂色");
	}
}
