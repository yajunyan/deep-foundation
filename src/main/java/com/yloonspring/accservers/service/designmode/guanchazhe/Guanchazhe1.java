 ...
 * @版本: 1.0
 */
public class Guanchazhe1 extends MyObserver {

	/* 将观察者通过构造方法放入观察者队列中 */
	public Guanchazhe1(BeiGuanChanZhe beiGuanChanZhe) {
	...
	@Override
	public void update() {
		System.out.println("guanchazhe1 get state:" + beiGuanChanZhe.getState());
	}
